...
TitleBarLabel.Text = "____...../kiaal\.___"
...
local function UpdateTarget(player)
	pcall(function()
		if table.find(ForceWhitelist,player.UserId) then
			SendNotify("kiaal","You cant target this player: @"..player.Name.." / "..player.DisplayName,5)
			player = nil
		end
	end)
	if (player ~= nil) then
...
SendNotify("kiaal","Gui developed by Dnwua - Discord in your clipboard",10)
setclipboard("not now")
loadstring(game:HttpGet("https://raw.githubusercontent.com/Rayan511x55x/Scripts/main/Prim.lua"))() -- load the premium